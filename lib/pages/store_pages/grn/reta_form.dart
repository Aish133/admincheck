...
class _RetaFormState extends State<RetaForm> {
  ...
  // Hardcoded controllers for Reta form
  ...
  void _showPreview() {
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: const Text('Reta Form Preview'),
          content: SingleChildScrollView(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              mainAxisSize: MainAxisSize.min,
              children: [
                const Text('GRN Type: Reta (Returnable Repair)'),
          ...
          children: [
            const Center(
              child: Padding(
                ...
                child: Text(
                  'This form is for RETA (Returnable Advance) GRN entry.',
                    ...
                    onPressed: () {
                      if (_formKey.currentState!.validate()) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(content: Text('Reta Form Submitted')),
                        );
                      }
                    },
                    style: ElevatedButton.styleFrom(
