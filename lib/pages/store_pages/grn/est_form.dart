...
class _EstFormState extends State<EstForm> {
  ...
  // Hardcoded controllers for EST form
  ...
  void _showPreview() {
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: const Text('EST Form Preview'),
          content: SingleChildScrollView(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              mainAxisSize: MainAxisSize.min,
              children: [
                const Text('GRN Type: EST (Non-GST, Not Returnable)'),
                    ...
                    onPressed: () {
                      if (_formKey.currentState!.validate()) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(content: Text('EST Form Submitted')),
                        );
                      }
                    },
                    style: ElevatedButton.styleFrom(
